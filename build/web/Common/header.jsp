...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="../css/shopping-status.css">
                                            ...
                                            <div class="col-md-6 hidden-xs">
                                                <div class="navbar-header navbar-right">
                                                    <ul class="nav nav-pills">
                                                        <a href="loginPage.jsp" class="nav-text-right">Đăng nhập</a> | 
                                                        <a href="registrationPage.jsp" class="nav-text-right">Đăng ký</a> | 
                                                        <a class="nav-text-right">Trợ giúp</a>
                                                    </ul>
                                                </div>
                                            </div>
                                        </nav>
                                ...
                                <div class="row">
                                    <nav class="navbar navbar-default navbar-fixed-top">
                                        ...
                                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                                            <div class="col-md-1">
                                                <a class="headr-logo" href="home.jsp">
                                            ...
                                            <div class="col-sm-4 navbar-right">
                                                <ul class="nav navbar-nav navbar-right">
                                                    ...
                                                    <li class="dropdown store-cicle">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            <li><a href="shoppingCartPage.jsp">Shopping cart</a></li>
                                                            <li><a href="#">Another action</a></li>
                                                            <li><a href="#">Something else here</a></li>
                                                            <li role="separator" class="divider"></li>
                                                            <li><a href="#">Separated link</a></li>
